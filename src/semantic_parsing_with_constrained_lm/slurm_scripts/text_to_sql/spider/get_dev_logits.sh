...
#SBATCH -o /home/estengel/semantic_parsing_with_constrained_lm/src/semantic_parsing_with_constrained_lm/logs/spider_dev_logits.out
#SBATCH -p brtx6
#SBATCH --gpus=1
...
VALIDATION_FILE="/brtx/601-nvme1/estengel/resources/data/benchclamp/processed/Spider/dev_all.jsonl" 
