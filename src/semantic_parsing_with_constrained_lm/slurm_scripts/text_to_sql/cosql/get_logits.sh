...
#SBATCH -o //brtx/601-nvme1/estengel/calflow_calibration/benchclamp/logs/cosql_get_logits.out
#SBATCH -p brtx6
#SBATCH --gpus=1
...
CHECKPOINT_DIR="/brtx/604-nvme2/estengel/calflow_calibration/benchclamp/1.0/t5-small-lm-adapt_cosql_past_all_db_val_all_0.0001//checkpoint-10000/"
VALIDATION_FILE="/brtx/601-nvme1/estengel/resources/data/benchclamp/processed/CoSQL/train_tiny.jsonl" 
