...
--exp-name-pattern 'gpt-3.5-turbo_lamp_no_context_all_scope_fol_0_test_eval_unconstrained-api_bs_5_np_full'
#--exp-name-pattern 'text-ada-001_lamp_no_context_all_scope_fol_2_test_eval_constrained_bs_5_np_full'
