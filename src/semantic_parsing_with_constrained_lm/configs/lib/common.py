...
from semantic_parsing_with_constrained_lm.index.bm25_index import DualBM25Retriever
        ...
        if use_gpt3:
            if prompt_order == PromptOrder.Shuffle:
                train_retriever: DataRetriever[FullDatumSub, DatumSub] = (
                    DualBM25Retriever(
                        train_data_refactored=train_data_refactored, 
            ...
            train_retriever = DualBM25Retriever(
                train_data_refactored=train_data_refactored, 
                train_data_original=train_data_original,
                perc_refactored=perc_refactored,
                top_k=num_examples_per_prompt
