...
class MyGPTBigCodePreTrainedModel(PreTrainedModel):
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, MyGPTBigCodeModel):
...
class MyGPTBigCodeModel(MyGPTBigCodePreTrainedModel):
...
class MyGPTBigCodeForCausalLM(MyGPTBigCodePreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"attn.masked_bias", r"attn.bias", r"lm_head.weight"]

    def __init__(self, config):
        super().__init__(config)
        self.transformer = MyGPTBigCodeModel(config)
